...
<html:form action="/EditConge.do" onsubmit="return configureValidation1conge();" >
<table>
<tr><td>
<label for="nom" id="nomL" class="fixedLabel">Nom du congé:</label>
</td><td><html:text name="conge" property="nom" styleId="nom" onkeydown="return blockEnter(event)" /></td></tr>
<tr>
<td>
...
<td>
<input type="text" name="date_Debut" id="date_Debut" onkeydown="return blockEnter(event)" size="11" onblur="dp_dateFormat='dd/mm/yyyy';magicDate(this)" onfocus="if (this.className != 'error') this.select()" value="<%= conge1.getDate_Debut() %>"> <a href="javascript:void(0);" onclick="g_Calendar.show(event, 'date_Debut', 'dd/mm/yyyy')" title="Show popup calendar"><img src="js/cal/calendar.gif" border="0"></a>(jj/mm/aaaa)
</td>
</tr>
<tr>
<td>
...
<td>
<input type="text" name="date_Fin" id="date_Fin" onkeydown="return blockEnter(event)" size="11" onblur="dp_dateFormat='dd/mm/yyyy';magicDate(this)" onfocus="if (this.className != 'error') this.select()" value="<%= conge1.getDate_Fin() %>"> <a href="javascript:void(0);" onclick="g_Calendar.show(event, 'date_Fin', 'dd/mm/yyyy')" title="Show popup calendar"><img src="js/cal/calendar.gif" border="0"></a>(jj/mm/aaaa)
</td>
</tr>
<tr>
<td>
...
<a class="submitButton" href="#" onclick="checkConge()">Ajouter Congé</a>
</td></tr>
</table>
