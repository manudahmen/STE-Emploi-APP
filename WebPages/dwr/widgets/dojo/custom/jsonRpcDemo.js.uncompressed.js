...
if(!dojo._hasResource["custom.jsonrpcDemo"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["custom.jsonrpcDemo"] = true;
